...
htmlhelp_basename = "ODRIMotorBoardFirmwareforCANCommunicationdoc"
...
latex_documents = [
    (
        master_doc,
        "ODRIMotorBoardFirmwareforCANCommunication.tex",
        "ODRI Motor Board Firmware for CAN Communication Documentation",
        "Felix Widmaier",
        "manual",
    ),
]
...
man_pages = [
    (
        master_doc,
        "odrimotorboardfirmwareforcancommunication",
        "ODRI Motor Board Firmware for CAN Communication Documentation",
        [author],
        1,
    )
